        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Shed No-29, Gopal Charan Industrial Zone, B/H Safari Hotel NR, Alok Estate Odhav, Ahmedabad.
                    </p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+91 9574512698</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>psquareenterprise20@gmail.com</p>
