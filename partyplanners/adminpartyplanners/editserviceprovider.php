								...
								<div class="form-body">
									<form enctype="multipart/form-data" method="post"> 
                                        ...
                                        <div class="form-group"> 
                                         ...
                                         <div class="form-group"> 
											<label for="exampleInputPassword1">logo</label><img src="serviceproviderlogo/<?php echo $logo; ?>" style="height:100px;width:120px;display:inline;margin-right:20px;float:left;" /><br /><br /><input type="file" name="logo" id="logo" style="float:left;" />
